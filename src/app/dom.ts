...
export function getDomRefs(): DomRefs {
  return {
    ...
    editorSplit: requiredElement<HTMLElement>("editorSplit"),
    editorPane: requiredElement<HTMLElement>("editorPane"),
    previewPane: requiredElement<HTMLElement>("previewPane"),
    editorViewModeGroup: requiredElement<HTMLElement>("editorViewModeGroup"),
    editorViewSourceBtn: requiredElement<HTMLButtonElement>("editorViewSourceBtn"),
    editorViewSplitBtn: requiredElement<HTMLButtonElement>("editorViewSplitBtn"),
    editorViewPreviewBtn: requiredElement<HTMLButtonElement>("editorViewPreviewBtn"),
    ...
    documentLinterStatus: requiredElement<HTMLElement>("documentLinterStatus"),
    documentLinterResults: requiredElement<HTMLElement>("documentLinterResults"),
  };
}
